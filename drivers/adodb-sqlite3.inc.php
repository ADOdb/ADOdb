...
class ADODB_sqlite3 extends ADOConnection
{
    ...
    /**
     * The database excaping method for string quotes
     *
     * @var string
     */
    public $replaceQuote = "''";
    ...
    /**
     * The database concatenation operator
     *
     * @var string
     */
     ...
     * @var string
     */
    public $sysDate = "DATE('now','localtime')";
     ...
     * @var string
     */
    public $sysTimeStamp = "DATETIME('now','localtime')";
    ...
    /**
     * String to generate a sequence table because sequences
     * arent natively supported
     *
     * @var string
     */
    ...
    public function _connect($argHostname, $argUsername, $argPassword, $argDatabasename)
    {
        ...
        $this->_connectionID->createFunction(
            'adodb_date',
    ...
    public function genID($seqname = 'adodbseq', $startID = 1)
    {
        ...
        if ($fn = $this->raiseErrorFn) {
            $fn(
                ...
                'GENID',
                -32000,
                "Unable to generate unique id after $MAXLOOPS attempts",
                $seqname,
                $num
            );
        }
