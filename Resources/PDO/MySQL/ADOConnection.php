 ...
 */
namespace ADOdb\Resources\PDO\MySQL;

/*
 * Class ADODB_pdo_mysqli
 */
class ADOConnection extends \ADOdb\Resources\PDO\ADOBaseConnection {
	 ...
	 * @var string
	 */
	protected string $recordSetProvider      = 'PDO';
	 ...
	 * @var string
	 */
	protected string $pdoDriver = 'mysql';
...
//		return "from_unixtime(unix_timestamp($date)+$fraction)";
	 ...
	 */
	public function xmetaColumns($table, $normalize=true)
	{
