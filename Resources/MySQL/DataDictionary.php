...
require_once ADODB_DIR . '/Resources/DataDictionary.php';

use ADOConnection;
use ADOfieldObject;

class DataDictionary extends \ADOdb\Resources\DataDictionary
{
	...
	public bool $blobAllowsNotNull = true;

	public string $upperName = 'MYSQLI';
