...
class ADODB2_firebird extends ADODB_DataDict
{
	...
	var $seqPrefix = 's_';
	var $blobSize = 40000;
	var $renameColumn = 'ALTER TABLE %s ALTER COLUMN %s TO %s';
	...
	*/
	 ...
	 *
	 * @param string $tabname table-name
	 * @param string $flds column-name to be dropped
	 * @param string $tableflds Unused
	 * @param array|string $tableoptions Unused
	 *
	 * @return array with SQL strings
	 ...
	 *
	 * @param string $tabname table-name
	 * @param string $oldcolumn old colum-name
	 * @param string $newcolumn new colum-name
	 * @param string $flds column-name to be renamed
	 *
	 * @return array with SQL strings
	 */
